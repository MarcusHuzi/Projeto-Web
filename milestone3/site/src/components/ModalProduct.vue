    ...
    <div class="modal-backdrop" @click="close">
        <div class="modal">
            ...
            <div class="modal-prod-description">
                ...
                <h3>R$ {{ !isNaN(this.$parent.modalProduct.price)?this.$parent.modalProduct.price.toFixed(2):0 }}</h3>
            </div>
        </div>
    </div>
</template>
